...
/**
 * DTO for updating a widget in a dashboard.
 *
 * @param widget    the updated widget data (required)
 * @param updatedBy the user ID who updated the widget (required)
 * @author Rapid Assist Team
 * @since 1.0.0
 */
@Schema(description = "Request to update a widget in a dashboard")
public record UpdateWidgetRequestDto(
    @Schema(description = "Updated widget data", required = true)
