package com.gogidix.rapidassist.dashboard.configuration.service.infrastructure.messaging.kafka;
...
public class DashboardConfigurationServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(DashboardConfigurationServiceEventPublisher.class);
    private static final String TOPIC = "dashboard-configuration-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public DashboardConfigurationServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
