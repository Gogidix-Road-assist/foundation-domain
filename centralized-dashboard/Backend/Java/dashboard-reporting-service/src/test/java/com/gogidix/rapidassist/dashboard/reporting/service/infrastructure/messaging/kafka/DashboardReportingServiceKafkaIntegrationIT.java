...
@Testcontainers
@Timeout(60)
class DashboardReportingServiceKafkaIntegrationIT {
    ...
    void canProduceAndConsumeMessage() throws Exception {
        String topic = "dashboard-reporting-service.events";
        ...
        try (var producer = new KafkaProducer<String, String>(producerProps)) {
            var record = new ProducerRecord<>(topic, "test-key", "{\"eventType\":\"INTEGRATION_TEST\",\"service\":\"dashboard-reporting-service\"}");
