package com.gogidix.rapidassist.dashboard.reporting.service.infrastructure.messaging.kafka;
...
public class DashboardReportingServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(DashboardReportingServiceEventPublisher.class);
    private static final String TOPIC = "dashboard-reporting-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public DashboardReportingServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
