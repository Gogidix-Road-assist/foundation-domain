...
public class DashboardAnalyticsServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(DashboardAnalyticsServiceEventPublisher.class);
    private static final String TOPIC = "dashboard-analytics-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public DashboardAnalyticsServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
