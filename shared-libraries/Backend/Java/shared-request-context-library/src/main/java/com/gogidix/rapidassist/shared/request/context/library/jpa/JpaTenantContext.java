 ...
 * <p>
 * This class serves as a bridge between the string-based TenantContext in the shared-request-context-library
 * and the Long-based tenant IDs used in JPA entities. It provides convenient methods for converting
 * between the two formats and accessing the current tenant ID in a type-safe manner.
 * </p>
 * <p>
...
public final class JpaTenantContext {
     ...
     * request context into a Long value. If parsing fails or the tenant ID is not
     * present, it returns an empty Optional.
     * </p>
     *
     * @return Optional containing the tenant ID as Long if present and valid, empty otherwise
     */
    public static Optional<Long> getTenantId() {
        return com.gogidix.rapidassist.shared.request.context.library.domain.TenantContext.getTenantId()
    ...
    public static void setTenantId(Long tenantId) {
        ...
        com.gogidix.rapidassist.shared.request.context.library.domain.RequestContextHolder.set(
                com.gogidix.rapidassist.shared.request.context.library.domain.TenantContext.withTenantId(String.valueOf(tenantId))
        );
    }
    ...
    public static <T> T withTenantId(Long tenantId, java.util.function.Supplier<T> action) {
        ...
        return com.gogidix.rapidassist.shared.request.context.library.domain.TenantContext.withTenantId(
     ...
     * @return Optional containing the Long value if parsing succeeds, empty otherwise
     */
     ...
     */
    private static Long parseLongOrThrow(String value) {
        try {
