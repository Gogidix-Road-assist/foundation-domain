 ...
 *
 * <p>The resolver expects the JWT to be already authenticated and parsed by Spring Security,
 * with the claims available in the request attributes.</p>
 *
 * <p>This resolver has a priority of 250, making it higher than header-based resolvers
 * as JWT claims are considered more authoritative.</p>
 *
 * <p>Note: This resolver requires the spring-security-oauth2-resource-server dependency
 * to be present. If the dependency is not available, this resolver will gracefully
...
public class JwtTenantResolver implements TenantResolver {
     ...
     * @throws IllegalArgumentException if tenantClaimName is null or blank
     */
    public JwtTenantResolver(String tenantClaimName, int priority) {
    ...
    public boolean supports(Object request) {
        ...
        try {
            ...
            if (auth instanceof org.springframework.security.core.Authentication authentication) {
                Object principal = authentication.getPrincipal();
                return principal.getClass().getName().equals("org.springframework.security.oauth2.jwt.Jwt");
            }
