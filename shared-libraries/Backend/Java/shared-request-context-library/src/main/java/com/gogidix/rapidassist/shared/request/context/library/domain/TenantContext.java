...
public final class TenantContext {
    ...
    public static String getTenantIdOrThrow() {
        return getTenantId()
                .orElseThrow(() -> new com.gogidix.rapidassist.shared.request.context.library.exception.TenantNotFoundException(
                        "Tenant ID is required but not present in the current request context"
                ));
    }
     ...
     */
    public static RequestContext withTenantId(String tenantId) {
     ...
     * @throws IllegalArgumentException if tenantId is null or blank
     */
    public static <T> T withTenantId(String tenantId, java.util.function.Supplier<T> action) {
