 ...
 * Permissions are grouped by resource and action (e.g., user:read, vehicle:update).
 */
...
public class Permission {
    ...
    private void parsePermissionName(String name) {
    ...
    public String getFullName() {
        return resource != null && action != null ? resource + ":" + action : name;
    }
