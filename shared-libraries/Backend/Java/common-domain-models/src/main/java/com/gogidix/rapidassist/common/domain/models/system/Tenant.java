...
public class Tenant {
    ...
    @Size(max = 20)
        ...
        private String tenantType = "STANDARD"; // STANDARD, ENTERPRISE, TRIAL

        private String subscriptionTier; // FREE, BASIC, PROFESSIONAL, ENTERPRISE
    ...
    public boolean isTrial() {
        return "TRIAL".equals(tenantType);
    }
