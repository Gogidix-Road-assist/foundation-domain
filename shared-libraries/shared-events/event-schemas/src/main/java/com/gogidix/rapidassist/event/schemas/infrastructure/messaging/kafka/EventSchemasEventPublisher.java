package com.gogidix.rapidassist.event.schemas.infrastructure.messaging.kafka;
...
public class EventSchemasEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(EventSchemasEventPublisher.class);
    private static final String TOPIC = "event-schemas.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public EventSchemasEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
