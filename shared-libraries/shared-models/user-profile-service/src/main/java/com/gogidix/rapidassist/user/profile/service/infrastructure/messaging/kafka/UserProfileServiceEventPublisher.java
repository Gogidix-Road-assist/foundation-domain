package com.gogidix.rapidassist.user.profile.service.infrastructure.messaging.kafka;
...
public class UserProfileServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(UserProfileServiceEventPublisher.class);
    private static final String TOPIC = "user-profile-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public UserProfileServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
