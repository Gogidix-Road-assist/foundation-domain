package com.gogidix.rapidassist.common.domain.models.system;
...
/**
 * AuditLog entity for tracking all system events and changes.
 */
...
public class AuditLog {
    ...
    @Id
        ...
        private String actionType; // CREATE, UPDATE, DELETE, READ, LOGIN, LOGOUT, etc.

        private String entityType; // User, Customer, ServiceRequest, etc.
