...
/**
 * VehicleDocument entity for storing vehicle-related documents.
 */
@Document(collection = "vehicle_document")
public class VehicleDocument {
    ...
    @Size(max = 50)
        private String documentType; // REGISTRATION, INSURANCE, MOT, SERVICE_RECORD
