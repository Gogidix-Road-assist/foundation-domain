package com.gogidix.rapidassist.orchestration.executiveaggregation.infrastructure.messaging.kafka;
...
@Testcontainers
@Timeout(60)
class ExecutiveAggregationServiceKafkaIntegrationIT {
    ...
    void canProduceAndConsumeMessage() throws Exception {
        String topic = "executive-aggregation-service.events";
        ...
        try (var producer = new KafkaProducer<String, String>(producerProps)) {
            var record = new ProducerRecord<>(topic, "test-key", "{\"eventType\":\"INTEGRATION_TEST\",\"service\":\"executive-aggregation-service\"}");
