...
@SpringBootTest
@EmbeddedKafka(partitions = 1, topics = {"executive-aggregation-service.events"})
@DirtiesContext
@ActiveProfiles("test")
...
@Timeout(30)
class ExecutiveAggregationServiceEventPublisherTest {
    ...
    void canPublishEventToTopic() {
        ...
        var future = kafkaTemplate.send(topic, "test-key", Map.of(
            ...
            "service", "executive-aggregation-service",
