package com.gogidix.rapidassist.orchestration.matching.shared.requestcontext;
...
public final class RequestContext {
    ...
    public void setTenantId(String tenantId) {
        // Immutable - setter provided for backward compatibility
        throw new UnsupportedOperationException("RequestContext is immutable. Use builder to create new instance.");
    }
