...
/**
 * LEAST_COST matching algorithm
 * Finds the most cost-effective providers
 */
@Component
@RequiredArgsConstructor
public class LeastCostAlgorithmStrategy implements MatchingAlgorithmStrategy {
    ...
    public MatchingResult match(
        ...
        List<ProviderMatch> rankedProviders = scoredProviders.stream()
            .filter(p -> p.getEstimatedCost() != null && p.getEstimatedCost() > 0)
            .sorted(Comparator.comparingDouble(ProviderMatch::getEstimatedCost))
            .collect(Collectors.toList());
        ...
        return MatchingResult.builder()
            ...
            .algorithm(MatchingAlgorithm.LEAST_COST)
    ...
    public MatchingAlgorithm getAlgorithmType() {
        return MatchingAlgorithm.LEAST_COST;
    }
}
