package com.gogidix.rapidassist.orchestration.monitoringservice.infrastructure.messaging.kafka;
...
@Testcontainers
@Timeout(60)
class MonitoringServiceKafkaIntegrationIT {
    ...
    void canProduceAndConsumeMessage() throws Exception {
        String topic = "monitoring-service.events";
        ...
        try (var producer = new KafkaProducer<String, String>(producerProps)) {
            var record = new ProducerRecord<>(topic, "test-key", "{\"eventType\":\"INTEGRATION_TEST\",\"service\":\"monitoring-service\"}");
