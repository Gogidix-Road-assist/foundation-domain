...
@SpringBootTest
@EmbeddedKafka(partitions = 1, topics = {"country-aggregation-service.events"})
@DirtiesContext
@ActiveProfiles("test")
...
@Timeout(30)
class CountryAggregationServiceEventPublisherTest {
    ...
    void canPublishEventToTopic() {
        ...
        var future = kafkaTemplate.send(topic, "test-key", Map.of(
            ...
            "service", "country-aggregation-service",
