package com.gogidix.rapidassist.orchestration.countryaggregation.infrastructure.messaging.kafka;
...
@Testcontainers
@Timeout(60)
class CountryAggregationServiceKafkaIntegrationIT {
    ...
    void canProduceAndConsumeMessage() throws Exception {
        String topic = "country-aggregation-service.events";
        ...
        try (var producer = new KafkaProducer<String, String>(producerProps)) {
            var record = new ProducerRecord<>(topic, "test-key", "{\"eventType\":\"INTEGRATION_TEST\",\"service\":\"country-aggregation-service\"}");
