package com.gogidix.rapidassist.config.service.infrastructure.adapter.rest;
 ...
 *
 * <p>This adapter allows the config service to validate tenant IDs
...
public class TenantServiceApiClient {
    ...
    /**
     * Records a configuration access for auditing.
     *
     * @param tenantId    the tenant ID
