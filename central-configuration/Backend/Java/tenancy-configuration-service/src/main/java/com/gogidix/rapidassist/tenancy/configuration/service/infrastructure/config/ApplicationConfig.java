...
public class ApplicationConfig {
    ...
    public static class ValidationConfig {
        ...
        public boolean isEnforceUniqueTenantId() {
            return enforceUniqueTenantId;
        }

        public void setEnforceUniqueTenantId(boolean enforceUniqueTenantId) {
            this.enforceUniqueTenantId = enforceUniqueTenantId;
        }

        public boolean isEnforceUniqueDomain() {
            return enforceUniqueDomain;
        }

        public void setEnforceUniqueDomain(boolean enforceUniqueDomain) {
            this.enforceUniqueDomain = enforceUniqueDomain;
        }

        public boolean isValidateFeatureLimits() {
            return validateFeatureLimits;
        }

        public void setValidateFeatureLimits(boolean validateFeatureLimits) {
            this.validateFeatureLimits = validateFeatureLimits;
        }
    }
