...
@Testcontainers
@Timeout(60)
class TenancyConfigurationServiceKafkaIntegrationIT {
    ...
    void canProduceAndConsumeMessage() throws Exception {
        ...
        try (var producer = new KafkaProducer<String, String>(producerProps)) {
            var record = new ProducerRecord<>(topic, "test-key", "{\"eventType\":\"INTEGRATION_TEST\",\"service\":\"tenancy-configuration-service\"}");
