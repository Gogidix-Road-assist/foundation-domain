...
/**
 * Base class for all domain events in the Release Rollout Configuration service.
...
public abstract class DomainEvent<T> {
    ...
    /**
     * Gets the type of this event (e.g., "ReleaseRolloutCreated", "ReleaseRolloutUpdated").
     *
