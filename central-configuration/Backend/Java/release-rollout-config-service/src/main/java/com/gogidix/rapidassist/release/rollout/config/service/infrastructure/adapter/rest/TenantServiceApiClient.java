package com.gogidix.rapidassist.release.rollout.config.service.infrastructure.adapter.rest;
 ...
 *
 * <p>This adapter allows the rollout config service to validate tenant IDs
...
public class TenantServiceApiClient {
    ...
    /**
     * Records a rollout access for auditing.
     *
     * @param tenantId    the tenant ID
     * @param rolloutId   the rollout ID accessed
     * @param accessedBy  the user who accessed it
     */
    public void recordAccess(String tenantId, String rolloutId, String accessedBy) {
        try {
            ...
            Map<String, String> auditEntry = Map.of(
                "action", "ROLLOUT_ACCESS",
                "resource", "rollout:" + rolloutId,
                "userId", accessedBy
            );
