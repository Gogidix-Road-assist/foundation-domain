...
/**
 * MongoDB configuration for the release rollout config service.
 *
 * <p>Enables MongoDB repositories with tenant-aware indexing.
 * Connection settings are auto-configured by Spring Boot.
 */
@Configuration
@EnableMongoRepositories(basePackages = "com.gogidix.rapidassist.release.rollout.config.service.infrastructure.persistence")
