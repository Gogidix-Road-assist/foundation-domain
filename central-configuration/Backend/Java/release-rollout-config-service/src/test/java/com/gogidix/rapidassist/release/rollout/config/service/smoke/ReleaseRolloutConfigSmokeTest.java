package com.gogidix.rapidassist.release.rollout.config.service.smoke;
...
@ActiveProfiles("test")
@DisplayName("ReleaseRolloutConfig Smoke Tests")
public class ReleaseRolloutConfigSmokeTest {
