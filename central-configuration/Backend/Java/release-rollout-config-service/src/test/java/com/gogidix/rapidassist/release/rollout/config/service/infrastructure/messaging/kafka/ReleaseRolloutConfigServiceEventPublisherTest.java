...
@SpringBootTest
@EmbeddedKafka(partitions = 1, topics = {"release-rollout-config-service.events"})
@DirtiesContext
@ActiveProfiles("test")
...
@Timeout(30)
class ReleaseRolloutConfigServiceEventPublisherTest {
    ...
    void canPublishEventToTopic() {
        ...
        var future = kafkaTemplate.send(topic, "test-key", Map.of(
            ...
            "service", "release-rollout-config-service",
