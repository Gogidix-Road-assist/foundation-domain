package com.gogidix.rapidassist.policy.configuration.service.smoke;
...
@ActiveProfiles("test")
@DisplayName("PolicyConfiguration Smoke Tests")
public class PolicyConfigurationSmokeTest {
