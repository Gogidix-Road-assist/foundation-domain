...
public class ApplicationConfig {
    ...
    public static class ValidationConfig {
        ...
        public boolean isRequireApprovalForCritical() {
            return requireApprovalForCritical;
        }

        public void setRequireApprovalForCritical(boolean requireApprovalForCritical) {
            this.requireApprovalForCritical = requireApprovalForCritical;
        }

        public boolean isEnforceScopeValidation() {
            return enforceScopeValidation;
        }

        public void setEnforceScopeValidation(boolean enforceScopeValidation) {
            this.enforceScopeValidation = enforceScopeValidation;
        }
