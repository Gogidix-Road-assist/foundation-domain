...
/**
 * MongoDB configuration for the rate limit policy service.
 *
 * <p>Enables MongoDB repositories with tenant-aware indexing.
 * Connection settings are auto-configured by Spring Boot.
 */
@Configuration
@EnableMongoRepositories(basePackages = "com.gogidix.rapidassist.rate.limit.policy.service.infrastructure.persistence")
