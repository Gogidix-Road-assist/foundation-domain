package com.gogidix.rapidassist.dynamic.routing.config.service.smoke;
...
@ActiveProfiles("test")
@DisplayName("DynamicRoutingConfig Smoke Tests")
public class DynamicRoutingConfigSmokeTest {
