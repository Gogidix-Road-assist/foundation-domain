...
public class ApplicationConfig {
    ...
    public static class ValidationConfig {
        ...
        public boolean isRequireApprovalForProtectedRoutes() {
            return requireApprovalForProtectedRoutes;
        }

        public void setRequireApprovalForProtectedRoutes(boolean requireApprovalForProtectedRoutes) {
            this.requireApprovalForProtectedRoutes = requireApprovalForProtectedRoutes;
        }

        public boolean isEnforceCircuitBreakerForCritical() {
            return enforceCircuitBreakerForCritical;
        }

        public void setEnforceCircuitBreakerForCritical(boolean enforceCircuitBreakerForCritical) {
            this.enforceCircuitBreakerForCritical = enforceCircuitBreakerForCritical;
        }
