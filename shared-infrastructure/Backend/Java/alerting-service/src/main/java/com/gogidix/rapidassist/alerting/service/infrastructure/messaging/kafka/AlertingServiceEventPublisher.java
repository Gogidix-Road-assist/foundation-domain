package com.gogidix.rapidassist.alerting.service.infrastructure.messaging.kafka;
...
public class AlertingServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(AlertingServiceEventPublisher.class);
    private static final String TOPIC = "alerting-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public AlertingServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
