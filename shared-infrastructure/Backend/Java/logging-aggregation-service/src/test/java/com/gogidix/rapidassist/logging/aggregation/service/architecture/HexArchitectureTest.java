package com.gogidix.rapidassist.logging.aggregation.service.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.gogidix.rapidassist.logging.aggregation.service",
...
class HexArchitectureTest {
    ...
    static final ArchRule domain_layer_should_not_depend_on_other_layers =
            noClasses()
                    ...
                    .resideInAnyPackage("..application..", "..infrastructure..", "..adapters..", "..interfaces..")
    ...
    static final ArchRule application_layer_should_not_depend_on_interfaces =
            noClasses()
                    ...
                    .should().dependOnClassesThat()
                    .resideInAnyPackage("..adapters..", "..interfaces..")
                    .because("Application layer should not depend on interfaces/adapters");
    ...
    static final ArchRule controllers_should_be_named_correctly =
            classes()
                    ...
                    .because("Controllers should have Controller/Handler suffix");
    ...
    static final ArchRule services_should_be_named_correctly =
            classes()
                    ...
                    .or().haveSimpleNameEndingWith("Handler")
                    .because("Services should have appropriate suffix");

    @ArchTest
    static final ArchRule enforce_package_layering =
            slices()
                    .matching("com.gogidix.rapidassist.logging.aggregation.service.(*)..")
    ...
    @ArchTest
    static final ArchRule all_controllers_must_reside_in_adapters =
            classes()
                    .that().areAnnotatedWith(RestController.class)
                    .should().resideInAnyPackage("..adapters..", "..interfaces..");
