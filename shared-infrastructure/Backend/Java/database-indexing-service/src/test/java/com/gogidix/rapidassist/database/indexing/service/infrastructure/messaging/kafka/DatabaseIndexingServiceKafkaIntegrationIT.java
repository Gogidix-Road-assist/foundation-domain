...
@Testcontainers
@Timeout(60)
class DatabaseIndexingServiceKafkaIntegrationIT {
    ...
    void canProduceAndConsumeMessage() throws Exception {
        String topic = "database-indexing-service.events";
        ...
        try (var producer = new KafkaProducer<String, String>(producerProps)) {
            var record = new ProducerRecord<>(topic, "test-key", "{\"eventType\":\"INTEGRATION_TEST\",\"service\":\"database-indexing-service\"}");
