package com.gogidix.rapidassist.database.indexing.service.infrastructure.messaging.kafka;
...
public class DatabaseIndexingServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(DatabaseIndexingServiceEventPublisher.class);
    private static final String TOPIC = "database-indexing-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public DatabaseIndexingServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
    ...
    public void publishEvent(String eventType, String aggregateId, Object payload) {
        Map<String, Object> event = Map.of(
            ...
            "service", "database-indexing-service",
