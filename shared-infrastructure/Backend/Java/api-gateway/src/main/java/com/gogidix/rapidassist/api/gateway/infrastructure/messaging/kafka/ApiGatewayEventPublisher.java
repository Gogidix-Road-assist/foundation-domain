...
public class ApiGatewayEventPublisher {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ApiGatewayEventPublisher.class);
    private static final String TOPIC = "api-gateway.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public ApiGatewayEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
