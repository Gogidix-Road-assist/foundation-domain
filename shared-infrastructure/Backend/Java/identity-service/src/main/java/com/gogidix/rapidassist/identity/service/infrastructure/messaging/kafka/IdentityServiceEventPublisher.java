package com.gogidix.rapidassist.identity.service.infrastructure.messaging.kafka;
...
public class IdentityServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(IdentityServiceEventPublisher.class);
    private static final String TOPIC = "identity-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public IdentityServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
