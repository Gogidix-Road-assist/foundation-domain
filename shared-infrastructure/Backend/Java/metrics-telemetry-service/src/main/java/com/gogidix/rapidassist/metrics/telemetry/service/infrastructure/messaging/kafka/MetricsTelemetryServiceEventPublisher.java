package com.gogidix.rapidassist.metrics.telemetry.service.infrastructure.messaging.kafka;
...
public class MetricsTelemetryServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(MetricsTelemetryServiceEventPublisher.class);
    private static final String TOPIC = "metrics-telemetry-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public MetricsTelemetryServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
    ...
    public void publishEvent(String eventType, String aggregateId, Object payload) {
        Map<String, Object> event = Map.of(
            ...
            "service", "metrics-telemetry-service",
