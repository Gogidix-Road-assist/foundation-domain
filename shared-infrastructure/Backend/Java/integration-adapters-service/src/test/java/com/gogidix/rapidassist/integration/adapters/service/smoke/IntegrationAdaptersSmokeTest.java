package com.gogidix.rapidassist.integration.adapters.service.smoke;
...
@ActiveProfiles("test")
@DisplayName("IntegrationAdapters Smoke Tests")
public class IntegrationAdaptersSmokeTest {
