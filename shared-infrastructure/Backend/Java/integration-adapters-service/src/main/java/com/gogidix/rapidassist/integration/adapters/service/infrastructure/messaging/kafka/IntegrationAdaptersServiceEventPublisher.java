package com.gogidix.rapidassist.integration.adapters.service.infrastructure.messaging.kafka;
...
public class IntegrationAdaptersServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(IntegrationAdaptersServiceEventPublisher.class);
    private static final String TOPIC = "integration-adapters-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public IntegrationAdaptersServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
    ...
    public void publishEvent(String eventType, String aggregateId, Object payload) {
        Map<String, Object> event = Map.of(
            ...
            "service", "integration-adapters-service",
