...
public class ServiceHealthMonitorEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(ServiceHealthMonitorEventPublisher.class);
    private static final String TOPIC = "service-health-monitor.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public ServiceHealthMonitorEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
