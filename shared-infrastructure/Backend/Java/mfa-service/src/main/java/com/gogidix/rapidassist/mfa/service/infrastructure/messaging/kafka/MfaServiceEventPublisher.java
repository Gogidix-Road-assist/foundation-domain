package com.gogidix.rapidassist.mfa.service.infrastructure.messaging.kafka;
...
public class MfaServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(MfaServiceEventPublisher.class);
    private static final String TOPIC = "mfa-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public MfaServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
