package com.gogidix.rapidassist.service.health.monitor.service.smoke;
...
@ActiveProfiles("test")
@DisplayName("ServiceHealthMonitor Smoke Tests")
public class ServiceHealthMonitorSmokeTest {
