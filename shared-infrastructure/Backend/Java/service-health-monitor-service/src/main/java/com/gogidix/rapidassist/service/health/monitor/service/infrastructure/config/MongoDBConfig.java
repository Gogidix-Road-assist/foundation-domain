 ...
 *
 * Configures MongoDB with connection pooling for the service health monitor service.
 * Supports multi-tenant data isolation through tenant-scoped collections for health check data.
 *
 * @author Rapid Assist
 * @version 1.0.0
 */
...
public class MongoDBConfig extends AbstractMongoClientConfiguration {
    ...
    @Value("${spring.application.name:service-health-monitor-service}")
