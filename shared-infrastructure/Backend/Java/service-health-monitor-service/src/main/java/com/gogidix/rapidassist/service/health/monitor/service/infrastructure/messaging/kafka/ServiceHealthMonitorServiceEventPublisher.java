package com.gogidix.rapidassist.service.health.monitor.service.infrastructure.messaging.kafka;
...
public class ServiceHealthMonitorServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(ServiceHealthMonitorServiceEventPublisher.class);
    private static final String TOPIC = "service-health-monitor-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public ServiceHealthMonitorServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
