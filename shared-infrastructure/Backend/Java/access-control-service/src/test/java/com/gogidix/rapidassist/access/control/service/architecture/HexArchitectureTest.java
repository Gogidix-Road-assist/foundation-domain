package com.gogidix.rapidassist.access.control.service.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.gogidix.rapidassist.access.control.service",
...
class HexArchitectureTest {
    ...
    static final ArchRule enforce_package_layering =
            slices()
                    .matching("com.gogidix.rapidassist.access.control.service.(*)..")
