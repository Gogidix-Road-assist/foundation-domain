...
public class ApplicationConfig implements WebMvcConfigurer {
    ...
    @Bean
    public com.gogidix.rapidassist.access.control.service.domain.policy.AccessControlPolicy accessControlPolicy() {
        return new com.gogidix.rapidassist.access.control.service.domain.policy.AccessControlPolicy();
    }
}
