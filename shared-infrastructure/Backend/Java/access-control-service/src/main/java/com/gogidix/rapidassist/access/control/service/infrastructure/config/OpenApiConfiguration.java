    ...
    public OpenAPI accessControlServiceOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Service for managing access control, permissions, and role-based authorization within the Rapid Assist Foundation Domain shared infrastructure")
                        .version("1.0.0"))
