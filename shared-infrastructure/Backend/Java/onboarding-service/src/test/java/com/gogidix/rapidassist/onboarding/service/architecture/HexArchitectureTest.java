package com.gogidix.rapidassist.onboarding.service.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.gogidix.rapidassist.onboarding.service",
...
class HexArchitectureTest {
    ...
    @ArchTest
    static final ArchRule application_layer_should_not_depend_on_adapters =
            noClasses()
    ...
    @ArchTest
    static final ArchRule infrastructure_should_not_depend_on_adapters =
            classes()
                    .that().resideInAPackage("..infrastructure..")
                    .should().onlyDependOnClassesThat()
                    .resideInAnyPackage("..infrastructure..", "..domain..", "..application..",
                            "java..", "org.springframework..", "com.gogidix.rapidassist.shared..")
                    .because("Infrastructure should only depend on domain, application, and frameworks");
    ...
    static final ArchRule enforce_package_layering =
            slices()
                    .matching("com.gogidix.rapidassist.onboarding.service.(*)..")
