package com.gogidix.rapidassist.api.keys.service.infrastructure.messaging.kafka;
...
public class ApiKeysServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(ApiKeysServiceEventPublisher.class);
    private static final String TOPIC = "api-keys-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public ApiKeysServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
