package com.gogidix.rapidassist.idempotency.service.infrastructure.messaging.kafka;
...
public class IdempotencyServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(IdempotencyServiceEventPublisher.class);
    private static final String TOPIC = "idempotency-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public IdempotencyServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
