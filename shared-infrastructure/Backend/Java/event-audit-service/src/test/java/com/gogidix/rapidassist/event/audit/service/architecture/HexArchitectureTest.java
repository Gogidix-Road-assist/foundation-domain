package com.gogidix.rapidassist.event.audit.service.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.gogidix.rapidassist.event.audit.service",
...
class HexArchitectureTest {
    ...
    static final ArchRule enforce_package_layering =
            slices()
                    .matching("com.gogidix.rapidassist.event.audit.service.(*)..")
