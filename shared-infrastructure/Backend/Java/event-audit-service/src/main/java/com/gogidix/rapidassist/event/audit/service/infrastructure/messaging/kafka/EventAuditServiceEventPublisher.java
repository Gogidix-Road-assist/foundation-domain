package com.gogidix.rapidassist.event.audit.service.infrastructure.messaging.kafka;
...
public class EventAuditServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(EventAuditServiceEventPublisher.class);
    private static final String TOPIC = "event-audit-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public EventAuditServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
