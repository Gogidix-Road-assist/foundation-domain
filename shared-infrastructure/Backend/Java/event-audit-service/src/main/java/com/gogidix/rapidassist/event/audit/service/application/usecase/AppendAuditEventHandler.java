...
@Component
public class AppendAuditEventHandler implements AppendAuditEventCommand {

    private final AuditEventStore store;
    private final AuditRetentionProperties retentionProperties;

    public AppendAuditEventHandler(AuditEventStore store, AuditRetentionProperties retentionProperties) {
        this.store = store;
