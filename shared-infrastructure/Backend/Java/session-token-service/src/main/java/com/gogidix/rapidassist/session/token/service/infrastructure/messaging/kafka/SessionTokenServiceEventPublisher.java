package com.gogidix.rapidassist.session.token.service.infrastructure.messaging.kafka;
...
public class SessionTokenServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(SessionTokenServiceEventPublisher.class);
    private static final String TOPIC = "session-token-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public SessionTokenServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
