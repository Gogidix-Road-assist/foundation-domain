package com.gogidix.rapidassist.service.registry.discovery.smoke;
...
@ActiveProfiles("test")
@DisplayName("ServiceRegistryDiscovery Smoke Tests")
public class ServiceRegistryDiscoverySmokeTest {
