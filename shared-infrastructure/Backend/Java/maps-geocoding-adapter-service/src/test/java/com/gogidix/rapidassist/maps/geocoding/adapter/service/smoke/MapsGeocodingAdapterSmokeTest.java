package com.gogidix.rapidassist.maps.geocoding.adapter.service.smoke;
...
@ActiveProfiles("test")
@DisplayName("MapsGeocodingAdapter Smoke Tests")
public class MapsGeocodingAdapterSmokeTest {
