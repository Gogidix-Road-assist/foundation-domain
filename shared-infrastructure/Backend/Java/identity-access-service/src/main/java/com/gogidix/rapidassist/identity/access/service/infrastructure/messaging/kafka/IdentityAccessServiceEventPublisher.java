package com.gogidix.rapidassist.identity.access.service.infrastructure.messaging.kafka;
...
public class IdentityAccessServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(IdentityAccessServiceEventPublisher.class);
    private static final String TOPIC = "identity-access-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public IdentityAccessServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
