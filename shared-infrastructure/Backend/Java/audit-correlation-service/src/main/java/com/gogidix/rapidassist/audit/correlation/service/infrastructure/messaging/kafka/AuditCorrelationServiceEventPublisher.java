package com.gogidix.rapidassist.audit.correlation.service.infrastructure.messaging.kafka;
...
public class AuditCorrelationServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(AuditCorrelationServiceEventPublisher.class);
    private static final String TOPIC = "audit-correlation-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public AuditCorrelationServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
    ...
    public void publishEvent(String eventType, String aggregateId, Object payload) {
        Map<String, Object> event = Map.of(
            ...
            "service", "audit-correlation-service",
