 ...
 *
 * Configures MongoDB with connection pooling for the audit correlation service.
 * Supports multi-tenant data isolation through tenant-scoped collections for audit logs.
 *
 * @author Rapid Assist
 * @version 1.0.0
 */
...
public class MongoDBConfig extends AbstractMongoClientConfiguration {
    ...
    @Value("${spring.application.name:audit-correlation-service}")
