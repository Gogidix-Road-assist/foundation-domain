package com.gogidix.rapidassist.audit.correlation.service.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.gogidix.rapidassist.audit.correlation.service",
...
class HexArchitectureTest {
    ...
    static final ArchRule enforce_package_layering =
            slices()
                    .matching("com.gogidix.rapidassist.audit.correlation.service.(*)..")
