...
public class TenantOrgServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(TenantOrgServiceEventPublisher.class);
    private static final String TOPIC = "tenant-org-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public TenantOrgServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
