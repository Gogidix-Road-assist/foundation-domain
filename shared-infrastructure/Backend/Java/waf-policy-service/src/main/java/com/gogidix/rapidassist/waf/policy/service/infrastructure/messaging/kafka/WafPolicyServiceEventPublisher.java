package com.gogidix.rapidassist.waf.policy.service.infrastructure.messaging.kafka;
...
public class WafPolicyServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(WafPolicyServiceEventPublisher.class);
    private static final String TOPIC = "waf-policy-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public WafPolicyServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
