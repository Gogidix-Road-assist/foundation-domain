...
import com.gogidix.rapidassist.insurer.adapter.service.infrastructure.config.OpenApiConfiguration;
...
public class StatusController {
    ...
    @Operation(
            ...
            description = "Returns the current status of the Insurer Adapter Service"
    )
    @ApiResponses(value = {
