package com.gogidix.rapidassist.rate.limiting.service.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.gogidix.rapidassist.rate.limiting.service",
...
class HexArchitectureTest {
    ...
    static final ArchRule infrastructure_should_not_depend_on_domain =
            classes()
                    ...
                    .resideInAnyPackage("..infrastructure..", "..domain..", "..application..",
                            ...
                            "org.apache.kafka..", "com.fasterxml..", "com.mongodb..", "io.swagger..",
    ...
    static final ArchRule handlers_should_be_named_correctly =
            classes()
                    ...
                    .allowEmptyShould(true)
                    .because("Application handlers should have Handler or Service suffix");

    @ArchTest
    static final ArchRule enforce_package_layering =
            slices()
                    .matching("com.gogidix.rapidassist.rate.limiting.service.(*)..")
