...
public class RateLimitingServiceEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(RateLimitingServiceEventPublisher.class);
    private static final String TOPIC = "rate-limiting-service.events";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public RateLimitingServiceEventPublisher(KafkaTemplate<String, Object> kafkaTemplate) {
